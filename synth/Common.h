...
#define MAX_NUMBER_OF_VOICES 20
#define MAX_NUMBER_OF_OPERATORS 120
...
#define PREENFM_FREQUENCY_INVERSED_LFO PREENFM_FREQUENCY_INVERSED * (float) BLOCK_SIZE            //  styro
...
enum {
	...
	LFO_SEQ_MIDICLOCK_RETRIGGER_DIV_4,
	LFO_SEQ_MIDICLOCK_RETRIGGER_DIV_2,
	LFO_SEQ_MIDICLOCK_RETRIGGER,
	LFO_SEQ_MIDICLOCK_RETRIGGER_TIME_2,
	LFO_SEQ_MIDICLOCK_RETRIGGER_TIME_4,
};

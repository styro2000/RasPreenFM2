...
//
#ifndef _circle_screenx_h
#define _circle_screenx_h
...
class CScreenDeviceX : public CDevice	/// Writing characters to screen
{
public:
	...
	CScreenDeviceX (unsigned nWidth, unsigned nHeight, boolean bVirtual = FALSE);
	...
	boolean SetStatus (const TScreenStatusX &Status);
	...
	void SetCustomChar (u8 slot, unsigned char *font_data);
...
private:
	...
	boolean GetCustomPixel (u8 slot, unsigned nPosX, unsigned nPosY);

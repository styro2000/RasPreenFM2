...
const char* version[] = { ProgVersion OVERCLOCK_STRING };
const char* oledSaver[] = { "Off", "2m", "5m", "10m", "1h" };


const char* globalTuning[] = { "G" };
const char* inst1[] = { "Off", "1", "2", "3", "4", "12", "123", "1234"};
const char* voicelevel[] = { "dynamic      ", "fixTimbr -6dB","fixTimbr-12dB","fixTimbr-18dB","fixVoice-12dB", "fixVoice-18dB", "fixVoice-24dB", "fixVoice-32dB" };             // styro Voicelevel dynamic (normal preenfm2 modus), -6dB, -12dB, -18dB, -24dB
...
const struct MidiConfig midiConfig[]  = {
        ...
        {                                                       // styro Voicelevel dynamic (normal preenfm2 modus), fixedTimbre -6dB, -12dB, -18dB, -24dB fixedVoice -12dB, -18dB, -24dB
                "OutLvl: ",
                "voicelevel",
                4,
                voicelevel

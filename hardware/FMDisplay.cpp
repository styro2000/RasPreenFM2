...
const char* stepChars  = "_123456789ABCDEF\1";
...
unsigned int screenSaverGoal[] = { (unsigned int)(2*60 * TMP_FLOAT),(unsigned int)( 5*60*TMP_FLOAT),(unsigned int)( 10*60*TMP_FLOAT, 60*60*TMP_FLOAT) };

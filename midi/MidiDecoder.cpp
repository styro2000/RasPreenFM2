...
void MidiDecoder::controlChange(int timbre, MidiEvent& midiEvent) {
    ...
    if (receives & 0x01) {
        ...
        case CC_ENV_ATK_ALL_MODULATOR: {
            ...
            // styro midi attack ctrl also on env1
            this->synth->setNewValueFromMidi(timbre, ROW_LFOENV1, 0,(float)midiEvent.value[1] * .01562500000000000000f);
            break;
        }
        case CC_ENV_REL_OP1:
        case CC_ENV_REL_OP2:
        ...
        case CC_ENV_REL_ALL: {
            ...
            // styro midi release ctrl also on env1
            this->synth->setNewValueFromMidi(timbre, ROW_LFOENV1, 1,(float)midiEvent.value[1] * .03125000000000000000f);
            this->synth->setNewValueFromMidi(timbre, ROW_LFOENV1, 3,(float)midiEvent.value[1] * .03125000000000000000f);
        ...
        case CC_MPE_SLIDE_CC74:
            ...
            break;
        case CC_VOLUME:
			this->synth->setNewValueFromMidi(timbre, ROW_VOLUMES, timbre,(float)(midiEvent.value[1]) * INV127);
            break;
        }
    }
...
void MidiDecoder::setSerialMIDI(CSerialMIDI *pSerialMIDI){
    m_pSerialMIDI = pSerialMIDI;
}
